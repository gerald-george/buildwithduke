...
export const pageDefinitions: PageDefinition[] = [
  {
    ...
    content: {
      ...
      proof_values: ["65%", "73%", "1M+", "99%"],
      proof_labels: ["less manual workload", "lead growth", "views in seven days", "data integrity"],
      proof_copies: ["Automation that returns hours to the people doing the work.", "Digital systems designed around an outcome, not decoration.", "Campaign infrastructure ready when attention arrives.", "Library-science rigour applied to production software."],
      process_heading: "Clear steps. No mystery fog.",
      process_intro: "You always know what is being decided, built and tested.",
      process_titles: ["Discover", "Design", "Build", "Launch"],
      process_copies: ["Map the problem, users, constraints and the outcome worth paying for.", "Shape the flow and visual system before expensive code decisions settle.", "Ship in visible increments with clean interfaces and sensible adapters.", "Test the real journey, document the system and stay close after go-live."],
      process_logs: ["$ context --load", "$ prototype --test", "$ build --observe", "$ deploy --steady"],
      system_focus: "web products + AI automation",
      system_method: "clarify → build → observe",
      system_signal: "shipping, not theatre",
      system_ready: "ready for a useful problem",
      system_repo_count: "22",
      system_integrity: "99%",
      system_education: "1st",
  ...
  },
  {
    ...
    content: {
      ...
      experience_employers: ["Bedum Estate Management & Development LTD", "FOBSI International", "Twistreal Global Services"],
      experience_dates: ["Nov 2025 – Apr 2026", "Sep 2021 – Sep 2022", "Sep 2020 – Sep 2021"],
      ...
      education_institutions: ["University of Port Harcourt", "University of Port Harcourt", "U.S. Department of State · University of Nevada, Reno", "Academic libraries in Rivers State"],
      education_dates: ["2025", "2025", "2025", ""],
      ...
      certification_providers: ["Alison", "LinkedIn Learning", "Udemy", "CyberTech Enterprises"],
      certification_dates: ["In progress", "2024", "2022", "2020"],
    },
  },
  {
    slug: "blog", name: "Articles", path: "/articles",
