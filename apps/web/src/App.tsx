...
function PageMeta() {
  ...
  useEffect(() => {
    ...
    const value = project ? [`${project.title} case study — buildwithduke`, project.description] : article ? [`${article.title} — buildwithduke`, article.excerpt] : meta[key] || ["buildwithduke", "Full-stack products and useful automation."];
